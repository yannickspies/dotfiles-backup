...
description: Add MCP server from GitHub URL to global ~/.mcp.json
allowed-tools: Read, Write, Edit, WebFetch, Bash
---

Add the MCP server from GitHub repository `$1` to the global `~/.mcp.json` configuration.
...
3. Create or update `~/.mcp.json` in the home directory
...
Example usage: `/add-mcp-global https://github.com/AgentDeskAI/browser-tools-mcp`
